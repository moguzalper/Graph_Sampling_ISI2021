...
eta <- 2
n <- 1800
sqrt(((100000+n*(eta-1))/(n*eta)-1)*1000/100000/100000) # SE under poisson for n0=E(|s|)=1800; 
# pr.i becomes n0*lift/(N+Y*(lift-1)) for cases, and n0/(N+Y*(lift-1)) for non-cases
